...
function showSlides() {
    ...
    slideIndex++;
    if (slideIndex > slides.length) { slideIndex = 1 } // Перезапускаем слайд-шоу, если достигнут последний слайд

    // Показываем текущий слайд
    slides[slideIndex - 1].style.display = "block";

    // Запуск слайд-шоу через 3 секунды
...
// Массив с продуктами
const products = [
    { id: 1, name: 'Шаманский бубен', price: 10000, image: 'prod1.jpg', description: 'Шаманский бубен с уникальными свойствами.', quantity: 5 },
    { id: 2, name: 'Карты Таро - золотоеАртНуво', price: 1500, image: 'prod2.jpg', description: 'Красивый и функциональный продукт.', quantity: 3 },
...
if (registerForm) {
    registerForm.addEventListener('submit', function (event) {
        ...
        const newUser = { username: newUsername, password: newPassword, cart: [] };
        users.push(newUser);
        localStorage.setItem('users', JSON.stringify(users)); // Сохраняем массив пользователей
